      ...
      <div className="container mx-auto p-4">
        <div className="flex justify-center">
          ...
          >
            ...
            <button
              className="submit bg-light text-white py-2 px-4 rounded hover:bg-dark transition duration-200 w-[15rem]"
              type="submit"
            >
              Continue
            </button>
            ...
            <h5 className="mt-4">
              Don't have an account? <Link href="/sign-up" className="link text-blue-500 hover:underline">Sign Up</Link>
            </h5>
          </form>
        </div>
      </div>
